...
namespace CustomerService.Features.Customer.SwaggerDocumentation.v2
{
    public static class CreateCustomerConfiguration
    {
        public static OpenApiOperation ConfigureOpenApiOperation(OpenApiOperation operation)
        {
            ...
            operation.OperationId = "CreateCustomerHandler customer";
            operation.Summary = "CreateCustomerHandler customer summary";
            operation.Description = "CreateCustomerHandler customer API endpoint: Creates a new customerDto by providing relevant details in the request body and stores the information in the system.";
